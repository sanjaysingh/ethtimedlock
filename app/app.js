            ...
            if (typeof window.ethereum !== 'undefined') {
                ...
                if (accounts.length === 0) {
                    ...
                    if (requestedAccounts.length > 0) {
                        ...
                        this.contract = new ethers.Contract(TimedLockerV5Address, TimedLockerV5ABI, this.signer);
